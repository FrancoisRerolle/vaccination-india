...
## Vaccination campaign 1cs: identify district where FIC immunization campaign yields best increase in FIC, restricted to undervaccination threshold districts
...
## Vaccination campaign 1cs stratified by state: identify district where FIC immunization campaign yields best increase in FIC, restricted to undervaccination threshold districts
...
# Sequential vaccination campaigns: identify district where specific immunization yields best increase in specific vaccine coverage
